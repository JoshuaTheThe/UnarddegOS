override ARCH := amd64
override ARCH_CFLAGS += -m64 -fno-stack-protector -nostdlib -ffreestanding -fno-pie -Wall -Wextra -Werror
...
override ARCH_MODULE_FLAGS := -m64 -mno-tls-direct-seg-refs -fno-tls-model -U__TLS__
